<%-- 
    Document   : locs
    Created on : Nov 13, 2018, 5:06:32 PM
    Author     : Roger Brock
--%>
...
<html>
    ...
    <body>
        ...
        <div class="container" style="display: flex; justify-content: center;">
            <sec:authorize access="hasRole('ROLE_SIDEKICK')"><button type="button" class="btn btn-warning btn-lg" data-toggle="modal" data-target="#newModal">
                Add Location
            ...
            <ul class="list-group">
                <c:forEach var="l" items="${locList}">                 
                    <li class="list-group-item text-center">
                        <a href="loc?locId=${l.locId}">
                            <h6><c:out value="${l.locName}"/></h6>
                        </a>
                    </li>
                </c:forEach>
            </ul>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <sf:form class="form-horizontal" role="form"
                             action="newLoc" method="POST" modelAttribute="loc">
